package foro.hub.ForoHubApi.controller;

import foro.hub.ForoHubApi.domain.curso.Curso;
import foro.hub.ForoHubApi.domain.curso.CursoRepository;
import foro.hub.ForoHubApi.domain.topico.*;
import foro.hub.ForoHubApi.domain.usuario.Usuario;
import foro.hub.ForoHubApi.domain.usuario.UsuarioRepository;
